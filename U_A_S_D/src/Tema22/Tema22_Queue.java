...
public class Tema22_Queue {

    public static java.util.Queue<Integer> myQueue = new LinkedList<>(); // Define a queue

    public static void main(String[] args) 
    {
        Object[] myLinkedListToArr = myQueue.toArray(); // Temp Object Array to Convert myLinkedList to Object Array
